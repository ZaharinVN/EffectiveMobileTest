 ...
 */
public abstract class Hilt_AllTicketsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AllTicketsFragment() {
    super();
  }

  Hilt_AllTicketsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AllTicketsFragment_GeneratedInjector) this.generatedComponent()).injectAllTicketsFragment(UnsafeCasts.<AllTicketsFragment>unsafeCast(this));
    }
  }
