 ...
 */
public abstract class Hilt_BottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BottomSheet_GeneratedInjector) this.generatedComponent()).injectBottomSheet(UnsafeCasts.<BottomSheet>unsafeCast(this));
    }
  }
