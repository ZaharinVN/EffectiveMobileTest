 ...
 */
public abstract class Hilt_PlugFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PlugFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlugFragment_GeneratedInjector) this.generatedComponent()).injectPlugFragment(UnsafeCasts.<PlugFragment>unsafeCast(this));
    }
  }
